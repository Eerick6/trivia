...
// Datos de las preguntas (Nivel Medio)
const questions = [
    {
        question: "¿Qué es un balance general?",
        options: [
            "A) Un informe financiero que muestra la situación económica de una empresa.",
            "B) Un documento que registra las ventas diarias.",
    ...
    },
    {
        ...
        options: [
            "A) Una deuda que debe ser pagada.",
            "B) Un recurso que tiene valor económico.",
            "C) Un gasto operativo.",
        ],
        answer: 0,
    },
    {
        question: "¿Qué es un estado de resultados?",
        options: [
            "A) Un informe que muestra los ingresos y gastos de una empresa.",
...
let timerInterval;
const level = "medio"; // Nivel actual
...
function selectAnswer(selectedIndex) {
    ...
    if (selectedIndex === question.answer) {
        ...
        Swal.fire({
            title: "Incorrecto",
            text:
                "La respuesta correcta es: " + question.options[question.answer],
            icon: "error",
            confirmButtonText: "Siguiente",
        });
    }
...
function endGame() {
    ...
    const results = JSON.parse(
        localStorage.getItem(`results-${level}`)
    ...
    Swal.fire({
        ...
        html: `
            ...
            <p>Tiempo total: ${minutes.toString().padStart(2, "0")}:${seconds
                .toString()
                .padStart(2, "0")}</p>
        `,
        icon: "info",
